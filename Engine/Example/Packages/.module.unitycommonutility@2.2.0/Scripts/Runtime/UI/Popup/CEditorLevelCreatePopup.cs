...
public class CEditorLevelCreatePopup : CPopup {
	...
	public override void Awake() {
		...
		// 입력 필드를 설정한다 {
		m_oNumLevelsInput = this.Contents.ExFindComponent<InputField>(KCDefine.E_OBJ_N_EDITOR_LCP_NUM_LEVELS_INPUT);

		m_oMinNumCellsXInput = this.Contents.ExFindComponent<InputField>(KCDefine.E_OBJ_N_EDITOR_LCP_MIN_NUM_CELLS_X_INPUT);
		m_oMaxNumCellsXInput = this.Contents.ExFindComponent<InputField>(KCDefine.E_OBJ_N_EDITOR_LCP_MAX_NUM_CELLS_X_INPUT);

		m_oMinNumCellsYInput = this.Contents.ExFindComponent<InputField>(KCDefine.E_OBJ_N_EDITOR_LCP_MIN_NUM_CELLS_Y_INPUT);
		m_oMaxNumCellsYInput = this.Contents.ExFindComponent<InputField>(KCDefine.E_OBJ_N_EDITOR_LCP_MAX_NUM_CELLS_Y_INPUT);
		// 입력 필드를 설정한다 }
