...
public static class CScriptableObjCreator {
	...
	public static void CreateOptsInfoTable() {
		...
		oOptsInfoTable.SetBuildOptsInfo(new STBuildOptsInfo() {
			m_bIsUseSRPBatching = false, m_bIsPreBakeCollisionMesh = false, m_bIsPreserveFrameBufferAlpha = false, m_eNormapMapEncoding = NormalMapEncoding.DXT5nm, m_eLightmapper = LightingSettings.Lightmapper.ProgressiveCPU,
		...
		oOptsInfoTable.SetQualityOptsInfo(new STQualityOptsInfo() {
			...
			m_stNormQualityRenderingOptsInfo = new STRenderingOptsInfo() {
				m_stLightOptsInfo = new STLightOptsInfo() {
					m_eLightmapMaxSize = EPOT._2048, m_eLightmapMode = ELightmapMode.NON_DIRECTIONAL, m_eShadowmaskMode = ShadowmaskMode.Shadowmask, m_eShadowResolution = ShadowResolution.Medium, m_eLightmapCompression = LightmapCompression.NormalQuality
				},

				m_stUniversalRPOptsInfo = new STUniversalRPOptsInfo() {
					m_eLightCookieResolution = EPOT._512, m_eMainLightShadowResolution = EPOT._2048, m_eAdditionalShadowResolution = EPOT._1024
				}
			},

			m_stHighQualityRenderingOptsInfo = new STRenderingOptsInfo() {
				m_stLightOptsInfo = new STLightOptsInfo() {
					m_eLightmapMaxSize = EPOT._4096, m_eLightmapMode = ELightmapMode.COMBINE_DIRECTIONAL, m_eShadowmaskMode = ShadowmaskMode.DistanceShadowmask, m_eShadowResolution = ShadowResolution.High, m_eLightmapCompression = LightmapCompression.HighQuality
				},

				m_stUniversalRPOptsInfo = new STUniversalRPOptsInfo() {
					m_eLightCookieResolution = EPOT._1024, m_eMainLightShadowResolution = EPOT._4096, m_eAdditionalShadowResolution = EPOT._2048
				}
			},

			m_stUltraQualityRenderingOptsInfo = new STRenderingOptsInfo() {
				m_stLightOptsInfo = new STLightOptsInfo() {
					m_eLightmapMaxSize = EPOT._4096, m_eLightmapMode = ELightmapMode.COMBINE_DIRECTIONAL, m_eShadowmaskMode = ShadowmaskMode.DistanceShadowmask, m_eShadowResolution = ShadowResolution.VeryHigh, m_eLightmapCompression = LightmapCompression.HighQuality
				},
