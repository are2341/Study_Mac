	...
	public void Show(bool a_bIsResetRefCount = false, bool a_bIsShowBlindUIs = true) {
		...
		if(m_nRefCount > KCDefine.B_VAL_0_INT) {
			...
			if(a_bIsShowBlindUIs) {
				...
				var oTouchResponder = CSceneManager.ShowTouchResponder(oParent, KCDefine.U_OBJ_N_INDICATOR_TOUCH_RESPONDER, KCDefine.U_OBJ_P_G_INDICATOR_TOUCH_RESPONDER, KCDefine.U_COLOR_INDICATOR_BG, null, true);
