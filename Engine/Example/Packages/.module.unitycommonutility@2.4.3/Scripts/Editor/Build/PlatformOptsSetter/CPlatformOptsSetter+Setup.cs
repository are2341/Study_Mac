...
public static partial class CPlatformOptsSetter {
	...
	public static void SetupProjOpts() {
		var oCopyFileInfoListContainer = new List<List<(string, string)>>() {
			KCEditorDefine.B_DATA_P_INFO_LIST, KCEditorDefine.B_TABLE_P_INFO_LIST, KCEditorDefine.B_ASSEMBLY_DEFINE_P_INFO_LIST, KCEditorDefine.B_NOTI_ICON_P_INFO_LIST
		};
		...
		if(!File.Exists(KCEditorDefine.B_DATA_P_NOTI_PROJ_PROPERTIES)) {
			CFunc.WriteStr(KCEditorDefine.B_DATA_P_NOTI_PROJ_PROPERTIES, KCEditorDefine.B_TEXT_NOTI_PROJ_PROPERTIES);
		}

		// 파일이 없을 경우
		if(!File.Exists(KCEditorDefine.B_DATA_P_NOTI_ANDROID_MANIFEST)) {
			CFunc.WriteStr(KCEditorDefine.B_DATA_P_NOTI_ANDROID_MANIFEST, KCEditorDefine.B_TEXT_NOTI_ANDROID_MANIFEST);
		}
	...
	private static void SetupRenderingPipeline(EQualityLevel a_eQualityLevel, UniversalRenderPipelineAsset a_oRenderingPipeline, bool a_bIsEnableAssert = true) {
		...
		if(a_oRenderingPipeline != null) {
			...
			for(int i = 0; i < oRenderingPipelineRendererDataList.Count; ++i) {
				...
				if(oRenderingPipelineRendererDataList[i] != null) {
					var oIsSetupPipelineOptsList = new List<bool>() {
						...
						oRenderingPipelineRendererDataList[i].depthPrimingMode == DepthPrimingMode.Auto,
			...
			var oIsSetupOptsList = new List<bool>() {
				...
				(int)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_MSAA_QUALITY) == (int)MsaaQuality._2x,
				(int)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_OPAQUE_DOWN_SAMPLING) == (int)Downsampling._2xBilinear,
				...
				((float)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_2_SPLIT)).ExIsEquals(KCDefine.B_VAL_1_FLT / KCDefine.B_VAL_4_FLT),
			...
			if(oIsSetupOptsList.Contains(false)) {
				...
				a_oRenderingPipeline.ExSetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_OPAQUE_DOWN_SAMPLING, Downsampling._2xBilinear);
				...
				a_oRenderingPipeline.ExSetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_2_SPLIT, KCDefine.B_VAL_1_FLT / KCDefine.B_VAL_4_FLT);
...
#if UNITY_2022_1_OR_NEWER
			PlayerSettings.GetIl2CppCodeGeneration(NamedBuildTarget.iOS) == Il2CppCodeGeneration.OptimizeSpeed,
			PlayerSettings.GetIl2CppCodeGeneration(NamedBuildTarget.Android) == Il2CppCodeGeneration.OptimizeSpeed,
