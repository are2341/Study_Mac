...
public abstract partial class CSceneManager : CComponent {
	...
	protected virtual void SetupActiveScene() {
		...
		// 이벤트 시스템을 설정한다
		CSceneManager.m_oActiveSceneUIsDict[EKey.UIS_TOP].ExSetEnableComponent<EventSystem>(true, false);
		CSceneManager.m_oActiveSceneUIsDict[EKey.UIS_TOP].ExSetEnableComponent<BaseInputModule>(true, false);
	...
	protected virtual void SetupAdditiveScene() {
		// 카메라를 설정한다
		m_oCameraDict[EKey.UIS_CAMERA] = this.gameObject.scene.ExFindComponent<Camera>(KCDefine.U_OBJ_N_SCENE_UIS_CAMERA);
		m_oCameraDict[EKey.MAIN_CAMERA] = this.gameObject.scene.ExFindComponent<Camera>(KCDefine.U_OBJ_N_SCENE_MAIN_CAMERA);

		// UI 를 설정한다 {
		m_oUIsDict[EKey.UIS_TOP] = this.gameObject.scene.ExFindChild(KCDefine.U_OBJ_N_SCENE_UIS_TOP);
	...
	protected virtual void SetupDefObjs() {
		...
		m_oUIsDict[EKey.UIS_TOP] = CSceneManager.m_oActiveSceneUIsDict[EKey.UIS_TOP] = CSceneManager.ActiveSceneManager.gameObject.scene.ExFindChild(KCDefine.U_OBJ_N_SCENE_UIS_TOP);
		...
		// 카메라를 설정한다
		m_oCameraDict[EKey.UIS_CAMERA] = CSceneManager.m_oActiveSceneCameraDict[EKey.UIS_CAMERA] = CSceneManager.ActiveSceneManager.gameObject.scene.ExFindComponent<Camera>(KCDefine.U_OBJ_N_SCENE_UIS_CAMERA);
		...
		// 이벤트 시스템을 설정한다 {
		var oEventSystem = CSceneManager.m_oActiveSceneUIsDict[EKey.UIS_TOP].GetComponentInChildren<EventSystem>();
	...
	private void SetupTestUIs() {
		m_oUIsDict[EKey.TEST_CONTENTS_UIS]?.ExFindComponent<Button>(KCDefine.U_OBJ_N_OPEN_BTN)?.onClick.AddListener(this.OnTouchTestUIsOpenBtn);
		m_oUIsDict[EKey.TEST_CONTENTS_UIS]?.ExFindComponent<Button>(KCDefine.U_OBJ_N_CLOSE_BTN)?.onClick.AddListener(this.OnTouchTestUIsCloseBtn);
	}
