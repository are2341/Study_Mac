...
public abstract class CPopup : CComponent {
	...
	protected virtual Sequence CreateShowAni() {
		...
		switch(this.AniType) {
			case EAniType.SCALE: oAni = m_oContents.transform.DOScale(KCDefine.U_SCALE_POPUP, KCDefine.U_DURATION_POPUP_SCALE_ANI); break;
			case EAniType.DROPDOWN: oAni = m_oContents.transform.DOLocalMoveY(KCDefine.B_VAL_0_FLT, KCDefine.U_DURATION_POPUP_DROPDOWN_ANI); break;
			case EAniType.SLIDE_LEFT: case EAniType.SLIDE_RIGHT: oAni = m_oContents.transform.DOLocalMoveX(KCDefine.B_VAL_0_FLT, KCDefine.U_DURATION_POPUP_SLIDE_ANI); break;
		}
	...
	protected virtual Sequence CreateCloseAni() {
		...
		switch(this.AniType) {
			case EAniType.SCALE: oAni = m_oContents.transform.DOScale(KCDefine.U_MIN_SCALE_POPUP, KCDefine.U_DURATION_POPUP_SCALE_ANI); break;
			case EAniType.DROPDOWN: oAni = m_oContents.transform.DOLocalMoveY(CSceneManager.CanvasSize.y, KCDefine.U_DURATION_POPUP_DROPDOWN_ANI); break;
			case EAniType.SLIDE_LEFT: case EAniType.SLIDE_RIGHT: oAni = m_oContents.transform.DOLocalMoveX((this.AniType == EAniType.SLIDE_LEFT) ? -CSceneManager.CanvasSize.x : CSceneManager.CanvasSize.x, KCDefine.U_DURATION_POPUP_SLIDE_ANI); break;
		}
