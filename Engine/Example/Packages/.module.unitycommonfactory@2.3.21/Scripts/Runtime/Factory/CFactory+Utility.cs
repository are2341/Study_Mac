...
public static partial class CFactory {
	...
	/** 애니메이션을 생성한다 */
	public static Tween MakeAni(DOGetter<float> a_oGetter, DOSetter<float> a_oSetter, System.Action a_oInitCallback, System.Action<float> a_oSetterCallback, float a_fVal, float a_fDuration, Ease a_eEase = KCDefine.U_EASE_DEF, bool a_bIsRealtime = false) {
	...
	public static List<string> MakeAcquireItemInfoNodes() {
		return new List<string>() {
			KCDefine.U_NODE_FIREBASE_ACQUIRE_ITEM_INFOS
		};
	}
