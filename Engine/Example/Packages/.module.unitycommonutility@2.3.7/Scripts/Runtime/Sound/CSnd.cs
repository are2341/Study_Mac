...
public partial class CSnd : CComponent {
	...
	public bool IsIgnoreEffects {
		get { return m_oAudioSrc.bypassEffects; }
		set { m_oAudioSrc.bypassEffects = value; }
	}

	public bool IsIgnoreReverbZones {
		get { return m_oAudioSrc.bypassReverbZones; }
		set { m_oAudioSrc.bypassReverbZones = value; }
	}

	public bool IsIgnoreListenerEffects {
		get { return m_oAudioSrc.bypassListenerEffects; }
		set { m_oAudioSrc.bypassListenerEffects = value; }
	}
	...
	public void PlaySnd(AudioClip a_oAudioClip, bool a_bIsLoop, bool a_bIs3DSnd) {
		m_oAudioSrc.pitch = KCDefine.B_VAL_1_FLT;
		m_oAudioSrc.panStereo = KCDefine.B_VAL_0_FLT;
