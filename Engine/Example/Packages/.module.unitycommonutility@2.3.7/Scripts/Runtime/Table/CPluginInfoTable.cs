...
#if IRON_SRC_ADS_ENABLE
			[EAdsPlatform.IRON_SRC] = m_bIsEnableIronSrcBannerAds ? IronSourceAdUnits.BANNER : string.Empty
#endif			// #if IRON_SRC_ADS_ENABLE
		};
...
#if IRON_SRC_ADS_ENABLE
			[EAdsPlatform.IRON_SRC] = m_bIsEnableIronSrcRewardAds ? IronSourceAdUnits.REWARDED_VIDEO : string.Empty
#endif			// #if IRON_SRC_ADS_ENABLE
		};
...
#if IRON_SRC_ADS_ENABLE
			[EAdsPlatform.IRON_SRC] = m_bIsEnableIronSrcFullscreenAds ? IronSourceAdUnits.INTERSTITIAL : string.Empty
#endif			// #if IRON_SRC_ADS_ENABLE
		};
