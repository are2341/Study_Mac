		...
		oOptsInfoTable.SetQualityOptsInfo(new STQualityOptsInfo() {
			...
			m_stNormQualityRenderingOptsInfo = new STRenderingOptsInfo() {
				...
				m_stUniversalRPOptsInfo = new STUniversalRPOptsInfo() {
					m_eLightCookieResolution = EPOT._512, m_eMainLightShadowResolution = EPOT._1024, m_eAdditionalShadowResolution = EPOT._1024
				}
			},
			...
			m_stHighQualityRenderingOptsInfo = new STRenderingOptsInfo() {
				...
				m_stUniversalRPOptsInfo = new STUniversalRPOptsInfo() {
					m_eLightCookieResolution = EPOT._1024, m_eMainLightShadowResolution = EPOT._2048, m_eAdditionalShadowResolution = EPOT._2048
				}
			},
