...
public static partial class CPlatformOptsSetter {
	...
	public static void SetupProjOpts() {
		...
		var oCopyAssetInfoListContainer = new List<List<(string, string)>>() {
			...
			KCEditorDefine.B_ASSET_P_INFO_LIST,
			KCEditorDefine.B_SCENE_P_INFO_LIST,
			KCEditorDefine.B_PIPELINE_P_INFO_LIST
		};
	...
	private static void SetupRenderingPipeline(EQualityLevel a_eQualityLevel, UniversalRenderPipelineAsset a_oRenderingPipeline, bool a_bIsEnableAssert = true) {
		...
		if(a_oRenderingPipeline != null) {
			...
			var oIsSetupOptsList = new List<bool>() {
				...
				(bool)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_SUPPORTS_MIXED_LIGHTING),
				...
				(int)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_ADDITIONAL_LIGHT_PER_OBJ_LIMIT) == KCDefine.B_VAL_4_INT,
				...
				((Vector2)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_3_SPLIT)).ExIsEquals(KCEditorDefine.U_EDITOR_OPTS_CASCADE_3_SPLIT_PERCENT),
				((Vector3)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_4_SPLIT)).ExIsEquals(KCEditorDefine.U_EDITOR_OPTS_CASCADE_4_SPLIT_PERCENT)
			};
