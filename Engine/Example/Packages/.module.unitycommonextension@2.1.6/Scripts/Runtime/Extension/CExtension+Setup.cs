...
public static partial class CExtension {
	...
	public static void ExSetup3D(this Camera a_oSender, float a_fPlaneHeight, float a_fPlaneDistance, bool a_bIsEnableAssert = true) {
		CAccess.Assert(!a_bIsEnableAssert || (a_oSender != null && a_fPlaneHeight.ExIsGreate(KCDefine.B_VAL_0_FLT) && a_fPlaneDistance.ExIsGreate(KCDefine.B_VAL_0_FLT)));
		...
		if(a_oSender != null && (a_fPlaneHeight.ExIsGreate(KCDefine.B_VAL_0_FLT) && a_fPlaneDistance.ExIsGreate(KCDefine.B_VAL_0_FLT))) {
			...
			a_oSender.fieldOfView = (Mathf.Atan((a_fPlaneHeight / KCDefine.B_VAL_2_FLT) / a_fPlaneDistance) * KCDefine.B_VAL_2_FLT) * Mathf.Rad2Deg;
		}
	}
	#endregion			// 클래스 함수
}
