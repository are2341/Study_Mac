		...
		if(a_bIsMainSetup) {
			...
			if(this.MainCamera != null) {
				...
				if(oCameraData != null && QualitySettings.renderPipeline != null && GraphicsSettings.renderPipelineAsset != null) {
					var stLayerMask = oCameraData.volumeLayerMask.ExGetLayerVal(KCDefine.B_VAL_0_INT);
					stLayerMask.value = KCDefine.U_LAYER_MASKS_MAIN_CAMERA.ExToBits();

					oCameraData.renderShadows = true;
					oCameraData.renderType = CameraRenderType.Base;
					oCameraData.volumeLayerMask = stLayerMask;
