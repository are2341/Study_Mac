...
public partial class CCommonGameInfo : CCommonBaseInfo {
	...
	[JsonIgnore][IgnoreMember] public bool IsMuteBGSnd {
		get { return bool.Parse(m_oStrDict.GetValueOrDefault(KEY_IS_MUTE_BG_SND, KCDefine.B_TEXT_FALSE)); }
		set { m_oStrDict.ExReplaceVal(KEY_IS_MUTE_BG_SND, $"{value}"); }
	}

	[JsonIgnore][IgnoreMember] public bool IsMuteFXSnds {
		get { return bool.Parse(m_oStrDict.GetValueOrDefault(KEY_IS_MUTE_FX_SNDS, KCDefine.B_TEXT_FALSE)); }
		set { m_oStrDict.ExReplaceVal(KEY_IS_MUTE_FX_SNDS, $"{value}"); }
	}

	[JsonIgnore][IgnoreMember] public bool IsDisableVibrate {
		get { return bool.Parse(m_oStrDict.GetValueOrDefault(KEY_IS_DISABLE_VIBRATE, KCDefine.B_TEXT_FALSE)); }
		set { m_oStrDict.ExReplaceVal(KEY_IS_DISABLE_VIBRATE, $"{value}"); }
	}

	[JsonIgnore][IgnoreMember] public bool IsDisableNoti {
		get { return bool.Parse(m_oStrDict.GetValueOrDefault(KEY_IS_DISABLE_NOTI, KCDefine.B_TEXT_FALSE)); }
		set { m_oStrDict.ExReplaceVal(KEY_IS_DISABLE_NOTI, $"{value}"); }
	}

	[JsonIgnore][IgnoreMember] public float BGSndVolume {
		get { return float.Parse(m_oStrDict.GetValueOrDefault(KEY_BG_SND_VOLUME, KCDefine.B_STR_0_FLT)); }
		set { m_oStrDict.ExReplaceVal(KEY_BG_SND_VOLUME, $"{value}"); }
	}

	[JsonIgnore][IgnoreMember] public float FXSndsVolume {
		get { return float.Parse(m_oStrDict.GetValueOrDefault(KEY_FX_SNDS_VOLUME, KCDefine.B_STR_0_FLT)); }
		set { m_oStrDict.ExReplaceVal(KEY_FX_SNDS_VOLUME, $"{value}"); }
	}
	#endregion			// 프로퍼티
