...
public abstract class CComponent : MonoBehaviour {
	#region 변수
	protected Dictionary<string, int> m_oIntDict = null;
	protected Dictionary<string, float> m_oFltDict = null;
	protected Dictionary<string, string> m_oStrDict = null;
	#endregion			// 변수
	...
	public virtual bool IsIgnoreIntDict => true;
	public virtual bool IsIgnoreFltDict => true;
	public virtual bool IsIgnoreStrDict => true;
	#endregion			// 프로퍼티

	#region 함수
	/** 초기화 */
	public virtual void Awake() {
		m_oIntDict = this.IsIgnoreIntDict ? null : new Dictionary<string, int>();
		m_oFltDict = this.IsIgnoreFltDict ? null : new Dictionary<string, float>();
		m_oStrDict = this.IsIgnoreStrDict ? null : new Dictionary<string, string>();
	}
