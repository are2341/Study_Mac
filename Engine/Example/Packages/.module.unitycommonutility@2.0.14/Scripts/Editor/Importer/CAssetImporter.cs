...
public class CAssetImporter : AssetPostprocessor {
	...
	public virtual void OnPreprocessTexture() {
		...
		oTextureImporter.sRGBTexture = !oTextureImporter.assetPath.Contains(KCDefine.B_NAME_PATTERN_FIX_GAMMA_PIPELINE) && KCEditorDefine.B_ENABLE_SRGB_TEXTURE_TYPE_LIST.Contains(oTextureImporter.textureType);
	...
	private static void SetupTMPFontAsset(TMP_FontAsset a_oTMPFontAsset, string a_oImportAsset, string[] a_oRemoveAssets, string[] a_oMoveAssets, string[] a_oMoveAssetPaths) {
		...
		a_oTMPFontAsset.ExSetRuntimePropertyVal<TMP_FontAsset>(KCEditorDefine.B_PROPERTY_N_ATLAS_WIDTH, (int)EPowOfTwo._4096);
		a_oTMPFontAsset.ExSetRuntimePropertyVal<TMP_FontAsset>(KCEditorDefine.B_PROPERTY_N_ATLAS_HEIGHT, (int)EPowOfTwo._4096);
	}
	...
	private static void SetupTextureImporterPlatformSettings(TextureImporter a_oImporter, TextureImporterPlatformSettings a_oPlatformSettings, bool a_bIsDefPlatformSettings, bool a_bIsEnableAssert = true) {
		...
		if(a_oPlatformSettings != null) {
			a_oPlatformSettings.maxTextureSize = (int)EPowOfTwo._4096;
