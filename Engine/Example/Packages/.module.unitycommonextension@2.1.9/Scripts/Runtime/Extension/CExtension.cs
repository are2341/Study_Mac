...
public static partial class CExtension {
	...
	/** 위치 => 기준 위치로 변환한다 */
	public static Vector2 ExPosToPivotPos(this Vector2 a_stSender) {
		return new Vector2(a_stSender.x + (KCDefine.B_SCREEN_WIDTH / KCDefine.B_VAL_2_FLT), a_stSender.y + (KCDefine.B_SCREEN_HEIGHT / KCDefine.B_VAL_2_FLT));
	}
	...
	/** 위치 => 기준 위치로 변환한다 */
	public static Vector4 ExPosToPivotPos(this Vector4 a_stSender) {
		return new Vector4(a_stSender.x + (KCDefine.B_SCREEN_WIDTH / KCDefine.B_VAL_2_FLT), a_stSender.y + (KCDefine.B_SCREEN_HEIGHT / KCDefine.B_VAL_2_FLT), a_stSender.z, a_stSender.w);
	}

	/** 기준 위치 => 위치로 변환한다 */
	public static Vector2 ExPivotPosToPos(this Vector2 a_stSender) {
		return new Vector2(a_stSender.x - (KCDefine.B_SCREEN_WIDTH / KCDefine.B_VAL_2_FLT), a_stSender.y - (KCDefine.B_SCREEN_HEIGHT / KCDefine.B_VAL_2_FLT));
	}
	...
	/** 기준 위치 => 위치로 변환한다 */
	public static Vector4 ExPivotPosToPos(this Vector4 a_stSender) {
		return new Vector4(a_stSender.x - (KCDefine.B_SCREEN_WIDTH / KCDefine.B_VAL_2_FLT), a_stSender.y - (KCDefine.B_SCREEN_HEIGHT / KCDefine.B_VAL_2_FLT), a_stSender.z, a_stSender.w);
	}
