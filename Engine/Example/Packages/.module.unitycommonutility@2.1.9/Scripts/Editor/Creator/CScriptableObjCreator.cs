...
public static class CScriptableObjCreator {
	...
	public static void CreateOptsInfoTable() {
		...
		oOptsInfoTable.SetBuildOptsInfo(new STBuildOptsInfo() {
			m_bIsUseSRPBatching = false, m_bIsPreBakeCollisionMesh = false, m_bIsPreserveFrameBufferAlpha = false, m_eColorSpace = ColorSpace.Gamma, m_eNormapMapEncoding = NormalMapEncoding.DXT5nm, m_eLightmapper = LightingSettings.Lightmapper.ProgressiveCPU,
	...
	public static void CreateDefineSymbolInfoTable() {
		...
		oDefineSymbolInfoTable.SetSubCommonDefineSymbols(new List<string>() {
			...
			KCEditorDefine.DS_DEFINE_S_MODULE_VER_2_1_0_OR_NEWER,
	...
	public static void CreateProjInfoTable() {
		...
		oProjInfoTable.SetCommonProjInfo(new STCommonProjInfo() {
			m_oAppID = "dante.distribution.sample", m_oProjName = "03000111.Sample_Unity", m_oProductName = "Sample_Unity", m_oShortProductName = "Sample_Unity"
		});
