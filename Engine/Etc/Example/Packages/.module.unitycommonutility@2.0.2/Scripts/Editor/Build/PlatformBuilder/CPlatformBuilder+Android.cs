...
public static partial class CPlatformBuilder {
	...
	/** 안드로이드 원 스토어를 빌드한다 */
	public static void BuildAndroidOneStoreStoreDist() {
#if !NINETAP_BUILD_PIPELINE_ENABLE
		CPlatformBuilder.BuildAndroidOneStoreStoreA();
#endif			// #if !NINETAP_BUILD_PIPELINE_ENABLE
	}

	/** 안드로이드를 빌드한다 */
	private static void BuildAndroidDebug(EAndroidType a_eType, bool a_bIsAutoPlay) {
	...
	private static void BuildAndroidDebugWithAutoPlay(EAndroidType a_eType) {
		CPlatformBuilder.BuildAndroidDebug(a_eType, true);
	}
	...
	private static void BuildAndroidDebugWithRoboTest(EAndroidType a_eType) {
		...
		CPlatformBuilder.BuildAndroidDebug(a_eType, false);
	}
	...
	private static void BuildAndroid(EAndroidType a_eType, BuildPlayerOptions a_oPlayerOpts) {
		...
		switch(a_eType) {
			...
			case EAndroidType.ONE_STORE: CPlatformOptsSetter.AddDefineSymbol(a_oPlayerOpts.targetGroup, KCEditorDefine.DS_DEFINE_S_ANDROID_ONE_STORE_PLATFORM); break;
		...
		if(CPlatformOptsSetter.ProjInfoTable != null) {
			switch(a_eType) {
				...
				case EAndroidType.ONE_STORE: PlayerSettings.bundleVersion = CPlatformOptsSetter.ProjInfoTable.AndroidOneStoreProjInfo.m_stBuildVerInfo.m_oVer; break;
	...
	private static void RemoteBuildAndroidDebug(EAndroidType a_eType) {
		CPlatformBuilder.ExecuteAndroidJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_DEBUG, KCEditorDefine.B_DEBUG_BUILD_FUNC_JENKINS, KCEditorDefine.B_ANDROID_DEBUG_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_ANDROID_APK);
	}

	/** 안드로이드를 원격 빌드한다 */
	private static void RemoteBuildAndroidRelease(EAndroidType a_eType) {
		CPlatformBuilder.ExecuteAndroidJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_RELEASE_BUILD_FUNC_JENKINS, KCEditorDefine.B_ANDROID_RELEASE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_ANDROID_APK);
	}
	
	/** 안드로이드를 원격 빌드한다 */
	private static void RemoteBuildAndroidStoreA(EAndroidType a_eType) {
		CPlatformBuilder.ExecuteAndroidJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_A_BUILD_FUNC_JENKINS, KCEditorDefine.B_ANDROID_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_ANDROID_APK);
	}

	/** 안드로이드를 원격 빌드한다 */
	private static void RemoteBuildAndroidStoreB(EAndroidType a_eType) {
		CPlatformBuilder.ExecuteAndroidJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_B_BUILD_FUNC_JENKINS, KCEditorDefine.B_ANDROID_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_ANDROID_AAB);
	}

	/** 안드로이드를 원격 빌드한다 */
	private static void RemoteBuildAndroidStoreDistA(EAndroidType a_eType) {
		CPlatformBuilder.ExecuteAndroidJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_DIST_BUILD_FUNC_JENKINS, KCEditorDefine.B_ANDROID_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_ANDROID_APK);
	}

	/** 안드로이드를 원격 빌드한다 */
	private static void RemoteBuildAndroidStoreDistB(EAndroidType a_eType) {
		CPlatformBuilder.ExecuteAndroidJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_DIST_BUILD_FUNC_JENKINS, KCEditorDefine.B_ANDROID_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_ANDROID_AAB);
	}
	#endregion			// 클래스 함수
}
...
#if !NINETAP_BUILD_PIPELINE_ENABLE
	/** 원 스토어 크리에이티브를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Creative/OneStore/Release", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 2)]
	public static void BuildOneStoreCreativeRelease() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformOptsSetter.AddDefineSymbol(BuildTargetGroup.Standalone, KCEditorDefine.DS_DEFINE_S_CREATIVE_DIST_BUILD);

		CPlatformBuilder.BuildAndroidRelease(EAndroidType.ONE_STORE, false);
	}

	/** 원 스토어 크리에이티브를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Creative/OneStore/Release With AutoPlay", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 2)]
	public static void BuildOneStoreCreativeReleaseWithAutoPlay() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformOptsSetter.AddDefineSymbol(BuildTargetGroup.Standalone, KCEditorDefine.DS_DEFINE_S_CREATIVE_DIST_BUILD);

		CPlatformBuilder.BuildAndroidReleaseWithAutoPlay(EAndroidType.ONE_STORE);
	}
#endif			// #if !NINETAP_BUILD_PIPELINE_ENABLE
...
public static partial class CPlatformBuilder {
	...
	public static void BuildAndroidGoogleDebug() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidDebug(EAndroidType.GOOGLE, false);
	}
...
public static partial class CPlatformBuilder {
	...
	public static void BuildAndroidAmazonDebug() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidDebug(EAndroidType.AMAZON, false);
	}
...
public static partial class CPlatformBuilder {
	#region 클래스 함수
	/** 안드로이드 원 스토어를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/OneStore/Debug", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void BuildAndroidOneStoreDebug() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidDebug(EAndroidType.ONE_STORE, false);
	}

	/** 안드로이드 원 스토어를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/OneStore/Debug with AutoPlay", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void BuildAndroidOneStoreDebugWithAutoPlay() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidDebugWithAutoPlay(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/OneStore/Debug with RoboTest", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void BuildAndroidOneStoreDebugWithRoboTest() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidDebugWithRoboTest(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/OneStore/Release", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
	public static void BuildAndroidOneStoreRelease() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidRelease(EAndroidType.ONE_STORE, false);
	}

	/** 안드로이드 원 스토어를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/OneStore/Release with AutoPlay", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
	public static void BuildAndroidOneStoreReleaseWithAutoPlay() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidReleaseWithAutoPlay(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/OneStore/Distribution (APK)", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 301)]
	public static void BuildAndroidOneStoreStoreA() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildAndroidStoreA(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어를 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Android/OneStore/Debug", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void RemoteBuildAndroidOneStoreDebug() {
		CPlatformBuilder.RemoteBuildAndroidDebug(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어를 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Android/OneStore/Release", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
	public static void RemoteBuildAndroidOneStoreRelease() {
		CPlatformBuilder.RemoteBuildAndroidRelease(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어를 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Android/OneStore/Distribution (APK)", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 301)]
	public static void RemoteBuildAndroidOneStoreStoreA() {
		CPlatformBuilder.RemoteBuildAndroidStoreA(EAndroidType.ONE_STORE);
	}

	/** 안드로이드 원 스토어를 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Android/OneStore/Distribution (Store)", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 301)]
	public static void RemoteBuildAndroidOneStoreStoreDist() {
		CPlatformBuilder.RemoteBuildAndroidStoreDistA(EAndroidType.ONE_STORE);
	}
	#endregion			// 클래스 함수
}
#endif			// #if !NINETAP_BUILD_PIPELINE_ENABLE
