...
public static partial class CPlatformBuilder {
	...
	/** iOS 를 빌드한다 */
	private static void BuildiOSDebug(EiOSType a_eType, bool a_bIsAutoPlay) {
	...
	private static void BuildiOSDebugWithAutoPlay(EiOSType a_eType) {
		CPlatformBuilder.BuildiOSDebug(a_eType, true);
	}
	...
	private static void BuildiOS(EiOSType a_eType, BuildPlayerOptions a_oPlayerOpts) {
		...
		// 플랫폼을 빌드한다
		CFactory.MakeDirs(KCEditorDefine.B_ABS_BUILD_P_IOS);
		CPlatformBuilder.BuildPlatform(a_oPlayerOpts);
	}

	/** iOS 를 원격 빌드한다 */
	private static void RemoteBuildiOSDebug(EiOSType a_eType) {
		CPlatformBuilder.ExecuteiOSJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_DEBUG, KCEditorDefine.B_DEBUG_BUILD_FUNC_JENKINS, KCEditorDefine.B_IOS_DEBUG_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_IOS_IPA, CPlatformOptsSetter.BuildInfoTable.iOSBuildInfo.m_oDevProfileID, KCEditorDefine.B_IPA_EXPORT_METHOD_IOS_DEV);
	}

	/** iOS 를 원격 빌드한다 */
	private static void RemoteBuildiOSRelease(EiOSType a_eType) {
		CPlatformBuilder.ExecuteiOSJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_RELEASE_BUILD_FUNC_JENKINS, KCEditorDefine.B_IOS_RELEASE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_IOS_IPA, CPlatformOptsSetter.BuildInfoTable.iOSBuildInfo.m_oDevProfileID, KCEditorDefine.B_IPA_EXPORT_METHOD_IOS_DEV);
	}

	/** iOS 를 원격 빌드한다 */
	private static void RemoteBuildiOSStoreA(EiOSType a_eType) {
		CPlatformBuilder.ExecuteiOSJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_A_BUILD_FUNC_JENKINS, KCEditorDefine.B_IOS_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_IOS_IPA, CPlatformOptsSetter.BuildInfoTable.iOSBuildInfo.m_oStoreProfileID, KCEditorDefine.B_IPA_EXPORT_METHOD_IOS_STORE);
	}

	/** iOS 를 원격 빌드한다 */
	private static void RemoteBuildiOSStoreDist(EiOSType a_eType) {
		CPlatformBuilder.ExecuteiOSJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_DIST_BUILD_FUNC_JENKINS, KCEditorDefine.B_IOS_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_IOS_IPA, CPlatformOptsSetter.BuildInfoTable.iOSBuildInfo.m_oStoreProfileID, KCEditorDefine.B_IPA_EXPORT_METHOD_IOS_STORE);
	}
	#endregion			// 클래스 함수
}
...
public static partial class CPlatformBuilder {
	...
	public static void BuildiOSAppleDebug() {
		...
		CPlatformBuilder.BuildiOSDebug(EiOSType.APPLE, false);
	}
