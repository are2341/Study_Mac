...
public static partial class CPlatformBuilder {
	#region 클래스 함수
	/** 맥 애플을 빌드한다 */
	public static void BuildStandaloneMacAppleStoreDist() {
#if !NINETAP_BUILD_PIPELINE_ENABLE
		CPlatformBuilder.BuildStandaloneMacAppleStoreA();
	...
	/** 독립 플랫폼을 빌드한다 */
	private static void BuildStandaloneDebug(EStandaloneType a_eType, bool a_bIsAutoPlay) {
	...
	private static void BuildStandaloneDebugWithAutoPlay(EStandaloneType a_eType) {
		CPlatformBuilder.BuildStandaloneDebug(a_eType, true);
	}
	...
	private static void BuildStandalone(EStandaloneType a_eType, BuildPlayerOptions a_oPlayerOpts) {
		...
		string oBuildFileExtension = a_eType.ExIsWnds() ? KCEditorDefine.B_BUILD_FILE_EXTENSION_STANDALONE_EXE : KCEditorDefine.B_BUILD_FILE_EXTENSION_STANDALONE_APP;

		a_oPlayerOpts.target = a_eType.ExIsWnds() ? BuildTarget.StandaloneWindows64 : BuildTarget.StandaloneOSX;
		...
		switch(a_eType) {
			case EStandaloneType.MAC_STEAM: CPlatformOptsSetter.AddDefineSymbol(a_oPlayerOpts.targetGroup, KCEditorDefine.DS_DEFINE_S_STANDALONE_MAC_STEAM_PLATFORM); break;
			...
			default: CPlatformOptsSetter.AddDefineSymbol(a_oPlayerOpts.targetGroup, KCEditorDefine.DS_DEFINE_S_STANDALONE_MAC_APPLE_PLATFORM); break;
		}

		// 프로젝트 정보 테이블이 존재 할 경우
		if(CPlatformOptsSetter.ProjInfoTable != null) {
			switch(a_eType) {
				case EStandaloneType.MAC_STEAM: PlayerSettings.bundleVersion = CPlatformOptsSetter.ProjInfoTable.StandaloneMacSteamProjInfo.m_stBuildVerInfo.m_oVer; break;
				...
				default: PlayerSettings.bundleVersion = CPlatformOptsSetter.ProjInfoTable.StandaloneMacAppleProjInfo.m_stBuildVerInfo.m_oVer; break;
			}
		}
		// 빌드 옵션을 설정한다 }

		// 플랫폼을 빌드한다
		CFactory.MakeDirs(string.Format(KCEditorDefine.B_ABS_BUILD_P_FMT_STANDALONE, oPlatform));
		CPlatformBuilder.BuildPlatform(a_oPlayerOpts);
	}

	/** 독립 플랫폼을 원격 빌드한다 */
	private static void RemoteBuildStandaloneDebug(EStandaloneType a_eType) {
		CPlatformBuilder.ExecuteStandaloneJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_DEBUG, KCEditorDefine.B_DEBUG_BUILD_FUNC_JENKINS, KCEditorDefine.B_STANDALONE_DEBUG_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_STANDALONE_ZIP);
	}

	/** 독립 플랫폼을 원격 빌드한다 */
	private static void RemoteBuildStandaloneRelease(EStandaloneType a_eType) {
		CPlatformBuilder.ExecuteStandaloneJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_RELEASE_BUILD_FUNC_JENKINS, KCEditorDefine.B_STANDALONE_RELEASE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_STANDALONE_ZIP);
	}

	/** 독립 플랫폼을 원격 빌드한다 */
	private static void RemoteBuildStandaloneStoreA(EStandaloneType a_eType) {
		CPlatformBuilder.ExecuteStandaloneJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_A_BUILD_FUNC_JENKINS, KCEditorDefine.B_STANDALONE_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_STANDALONE_ZIP);
	}

	/** 독립 플랫폼을 원격 빌드한다 */
	private static void RemoteBuildStandaloneStoreDist(EStandaloneType a_eType) {
		CPlatformBuilder.ExecuteStandaloneJenkinsBuild(a_eType, KCDefine.B_BUILD_MODE_RELEASE, KCEditorDefine.B_STORE_DIST_BUILD_FUNC_JENKINS, KCEditorDefine.B_STANDALONE_STORE_PIPELINE_N_JENKINS, KCEditorDefine.B_BUILD_FILE_EXTENSION_STANDALONE_ZIP);
	}
	#endregion			// 클래스 함수
}
...
public static partial class CPlatformBuilder {
	...
	public static void BuildMacEditorDebug() {
		...
		CPlatformBuilder.BuildStandaloneDebug(EStandaloneType.MAC_APPLE, false);
	}
	...
	public static void BuildMacEditorDebugWithAutoPlay() {
		...
		CPlatformBuilder.BuildStandaloneDebugWithAutoPlay(EStandaloneType.MAC_APPLE);
	}
	...
	public static void BuildWndsEditorDebug() {
		...
		CPlatformBuilder.BuildStandaloneDebug(EStandaloneType.WNDS_STEAM, false);
	}
...
public static partial class CPlatformBuilder {
	#region 클래스 함수
	/** 맥 애플을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Standalone/Mac/Apple/Debug", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void BuildStandaloneMacAppleDebug() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildStandaloneDebug(EStandaloneType.MAC_APPLE, false);
	}

	/** 맥 애플을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Standalone/Mac/Apple/Debug with AutoPlay", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void BuildStandaloneMacAppleDebugWithAutoPlay() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildStandaloneDebugWithAutoPlay(EStandaloneType.MAC_APPLE);
	}

	/** 맥 애플을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Standalone/Mac/Apple/Release", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
	public static void BuildStandaloneMacAppleRelease() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildStandaloneRelease(EStandaloneType.MAC_APPLE, false);
	}

	/** 맥 애플을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Standalone/Mac/Apple/Release with AutoPlay", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
	public static void BuildStandaloneMacAppleReleaseWithAutoPlay() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildStandaloneReleaseWithAutoPlay(EStandaloneType.MAC_APPLE);
	}

	/** 맥 애플을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Standalone/Mac/Apple/Distribution", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 301)]
	public static void BuildStandaloneMacAppleStoreA() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildStandaloneStoreA(EStandaloneType.MAC_APPLE);
	}

	/** 맥 애플을 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Standalone/Mac/Apple/Debug", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	public static void RemoteBuildStandaloneMacAppleDebug() {
		CPlatformBuilder.RemoteBuildStandaloneDebug(EStandaloneType.MAC_APPLE);
	}

	/** 맥 애플을 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Standalone/Mac/Apple/Release", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
	public static void RemoteBuildStandaloneMacAppleRelease() {
		CPlatformBuilder.RemoteBuildStandaloneRelease(EStandaloneType.MAC_APPLE);
	}

	/** 맥 애플을 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Standalone/Mac/Apple/Distribution", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 301)]
	public static void RemoteBuildStandaloneMacAppleStoreA() {
		CPlatformBuilder.RemoteBuildStandaloneStoreA(EStandaloneType.MAC_APPLE);
	}

	/** 맥 애플을 원격 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Remote (Jenkins)/Standalone/Mac/Apple/Distribution (Store)", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 301)]
	public static void RemoteBuildStandaloneMacAppleStoreDist() {
		CPlatformBuilder.RemoteBuildStandaloneStoreDist(EStandaloneType.MAC_APPLE);
	}
	#endregion			// 클래스 함수
}
...
public static partial class CPlatformBuilder {
	...
	public static void BuildStandaloneMacSteamDebug() {
		CPlatformBuilder.BuildMethod = MethodBase.GetCurrentMethod().Name;
		CPlatformBuilder.BuildStandaloneDebug(EStandaloneType.MAC_STEAM, false);
	}
