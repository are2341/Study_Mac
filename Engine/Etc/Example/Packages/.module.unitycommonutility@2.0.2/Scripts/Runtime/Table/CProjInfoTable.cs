...
public class CProjInfoTable : CScriptableObj<CProjInfoTable> {
	...
	[SerializeField] private STProjInfo m_stAndroidOneStoreProjInfo;

	[Header("=====> Standalone Proj Info <=====")]
	[SerializeField] private STProjInfo m_stStandaloneMacAppleProjInfo;
	...
	public STProjInfo AndroidOneStoreProjInfo => m_stAndroidOneStoreProjInfo;

	public STProjInfo StandaloneMacAppleProjInfo => m_stStandaloneMacAppleProjInfo;
	...
	public override void Awake() {
		...
		this.ProjInfo = m_stAndroidOneStoreProjInfo;
#else
...
#else
		this.ProjInfo = m_stStandaloneMacAppleProjInfo;
	...
	/** 안드로이드 원 스토어 프로젝트 정보를 변경한다 */
	public void SetAndroidOneStoreProjInfo(STProjInfo a_stProjInfo) {
		m_stAndroidOneStoreProjInfo = a_stProjInfo;
	}
	
	/** 맥 애플 프로젝트 정보를 변경한다 */
	public void SetStandaloneMacAppleProjInfo(STProjInfo a_stProjInfo) {
		m_stStandaloneMacAppleProjInfo = a_stProjInfo;
	}
