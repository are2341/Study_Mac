...
public class CCommonGameInfo : CCommonBaseInfo {
	...
	[IgnoreMember] public bool IsMuteBGSnd {
		get { return m_oBoolList.ExGetVal(CCommonGameInfo.KEY_IS_MUTE_BG_SND, false); } 
		set { m_oBoolList.ExReplaceVal(CCommonGameInfo.KEY_IS_MUTE_BG_SND, value); }
	}

	[IgnoreMember] public bool IsMuteFXSnds {
		get { return m_oBoolList.ExGetVal(CCommonGameInfo.KEY_IS_MUTE_FX_SNDS, false); } 
		set { m_oBoolList.ExReplaceVal(CCommonGameInfo.KEY_IS_MUTE_FX_SNDS, value); }
	}

	[IgnoreMember] public bool IsDisableVibrate {
		get { return m_oBoolList.ExGetVal(CCommonGameInfo.KEY_IS_DISABLE_VIBRATE, false); } 
		set { m_oBoolList.ExReplaceVal(CCommonGameInfo.KEY_IS_DISABLE_VIBRATE, value); }
	}

	[IgnoreMember] public bool IsDisableNoti {
		get { return m_oBoolList.ExGetVal(CCommonGameInfo.KEY_IS_DISABLE_NOTI, false); } 
		set { m_oBoolList.ExReplaceVal(CCommonGameInfo.KEY_IS_DISABLE_NOTI, value); }
	}

	[IgnoreMember] public float BGSndVolume {
		get { return m_oFltList.ExGetVal(CCommonGameInfo.KEY_BG_SND_VOLUME, KCDefine.B_VAL_0_FLT); }
		set { m_oFltList.ExReplaceVal(CCommonGameInfo.KEY_BG_SND_VOLUME, value); }
	}

	[IgnoreMember] public float FXSndsVolume {
		get { return m_oFltList.ExGetVal(CCommonGameInfo.KEY_FX_SNDS_VOLUME, KCDefine.B_VAL_0_FLT); }
		set { m_oFltList.ExReplaceVal(CCommonGameInfo.KEY_FX_SNDS_VOLUME, value); }
	}
	#endregion			// 프로퍼티
