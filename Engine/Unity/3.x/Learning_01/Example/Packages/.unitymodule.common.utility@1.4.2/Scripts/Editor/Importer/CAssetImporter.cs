...
public class CAssetImporter : AssetPostprocessor {
	...
	//! Simple Scroll Snap 패키지를 추가한다
	[MenuItem("Tools/Utility/Import/SimpleScrollSnap Pkgs")]
	public static void ImportSimpleScrollSnapPkgs() {
		AssetDatabase.ImportPackage(KCEditorDefine.B_ABS_PKGS_P_SIMPLE_SCROLL_SNAP, true);
	}
