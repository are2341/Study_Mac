...
public static partial class CPlatformBuilder {
	...
	private static void BuildiOS(BuildPlayerOptions a_oPlayerOpts) {
		...
		CPlatformOptsSetter.AddDefineSymbol(BuildTargetGroup.iOS, KCEditorDefine.DS_DEFINE_S_NO_GPGS);
		...
		if(CPlatformOptsSetter.ProjInfoTable != null) {
			PlayerSettings.bundleVersion = CPlatformOptsSetter.ProjInfoTable.iOSProjInfo.m_stBuildVersion.m_oVersion;
		}
		// 빌드 옵션을 설정한다 }
