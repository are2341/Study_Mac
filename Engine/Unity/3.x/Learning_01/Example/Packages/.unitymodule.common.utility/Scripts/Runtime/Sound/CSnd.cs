...
public class CSnd : CComponent {
	...
	public void PlaySnd(AudioClip a_oAudioClip, bool a_bIsLoop, bool a_bIs3DSnd) {
		...
		m_oAudioSrc.dopplerLevel = a_bIs3DSnd ? m_oAudioSrc.dopplerLevel : KCDefine.B_VALUE_FLT_0;
		m_oAudioSrc.spatialBlend = a_bIs3DSnd ? m_oAudioSrc.spatialBlend : KCDefine.B_VALUE_FLT_0;
		m_oAudioSrc.reverbZoneMix = a_bIs3DSnd ? m_oAudioSrc.reverbZoneMix : KCDefine.B_VALUE_FLT_0;
