...
public sealed class CCommonUserInfo : CCommonBaseInfo {
	...
	#region 변수
	[Key(121)] public HashSet<string> m_oRestoreProductIDSet = new HashSet<string>();
	#endregion			// 변수

	#region 프로퍼티
	[IgnoreMember] public bool IsRemoveAds {
		get { return m_oBoolDict.ExGetVal(CCommonUserInfo.KEY_IS_REMOVE_ADS, false); } 
		set { m_oBoolDict.ExReplaceVal(CCommonUserInfo.KEY_IS_REMOVE_ADS, value); }
	}
	...
	public override void OnAfterDeserialize() {
		...
		m_oRestoreProductIDSet = m_oRestoreProductIDSet ?? new HashSet<string>();
	}
	#endregion			// 인터페이스
...
public class CCommonUserInfoStorage : CSingleton<CCommonUserInfoStorage> {
	...
	public bool IsRestoreProduct(string a_oProductID) {
		return this.UserInfo.m_oRestoreProductIDSet.Contains(a_oProductID);
	}
	...
	public void AddRestoreProductID(string a_oProductID) {
		...
		this.UserInfo.m_oRestoreProductIDSet.Add(a_oProductID);
	}
