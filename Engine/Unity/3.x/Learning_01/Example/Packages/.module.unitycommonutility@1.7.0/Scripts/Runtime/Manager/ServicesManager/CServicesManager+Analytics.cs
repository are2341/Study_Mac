...
#if ((UNITY_IOS || UNITY_ANDROID) && SERVICES_ANALYTICS_ENABLE) && (ANALYTICS_TEST_ENABLE || ADHOC_BUILD || STORE_BUILD)
		// 초기화 되었을 경우
		if(this.IsInit) {
...
#endif			// #if ((UNITY_IOS || UNITY_ANDROID) && SERVICES_ANALYTICS_ENABLE) && (ANALYTICS_TEST_ENABLE || ADHOC_BUILD || STORE_BUILD)
	}
	#endregion			// 함수
