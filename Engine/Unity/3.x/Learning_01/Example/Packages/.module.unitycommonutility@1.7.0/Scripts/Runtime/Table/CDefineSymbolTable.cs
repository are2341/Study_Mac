...
public class CDefineSymbolTable : CScriptableObj<CDefineSymbolTable> {
	...
	public override void Awake() {
		...
		this.iOSDefineSymbolList.ExAddVals(m_oiOSDefineSymbolList);
...
#if UNITY_ANDROID
#if ONE_STORE
		this.AndroidDefineSymbolList.ExAddVals(m_oOneStoreDefineSymbolList);
#elif GALAXY_STORE
		this.AndroidDefineSymbolList.ExAddVals(m_oGalaxyStoreDefineSymbolList);
#else
		this.AndroidDefineSymbolList.ExAddVals(m_oGoogleDefineSymbolList);
#endif			// #if ONE_STORE
#elif UNITY_STANDALONE
#if UNITY_STANDALONE_WIN
		this.StandaloneDefineSymbolList.ExAddVals(m_oWndsDefineSymbolList);
#else
		this.StandaloneDefineSymbolList.ExAddVals(m_oMacDefineSymbolList);
