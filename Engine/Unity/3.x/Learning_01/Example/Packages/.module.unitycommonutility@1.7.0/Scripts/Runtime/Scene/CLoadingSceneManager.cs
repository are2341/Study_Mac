...
public abstract class CLoadingSceneManager : CSceneManager {
	#region 프로퍼티
	public virtual float FadeInAniDuration => KCDefine.U_DURATION_SCREEN_FADE_IN_ANI;
	...
	public override void Start() {
		...
		if(CLoadingSceneManager.Callback == null) {
			...
			CSceneLoader.Inst.LoadSceneAsync(oSceneName, this.OnChangeLoadingState, KCDefine.B_VAL_0_FLT, false, bIsAni, false, this.FadeInAniDuration, CLoadingSceneManager.LoadSceneMode);
		}
	}
