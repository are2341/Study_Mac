...
public static partial class KEditorDefine {
	...
	public static readonly Dictionary<string, string> B_UNITY_PKGS_DEPENDENCY_LIST = new Dictionary<string, string>() {
		...
		["module.unitycommonads"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommonads_client.git#1.6.0",
#endif			// #if ADS_ENABLE || ADS_MODULE_ENABLE

#if FLURRY_ENABLE || FLURRY_MODULE_ENABLE
		["module.unitycommonflurry"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommonflurry_client.git#1.6.0",
#endif			// #if FLURRY_ENABLE || FLURRY_MODULE_ENABLE

#if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE
		["module.unitycommonfacebook"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommonfacebook_client.git#1.6.0",
#endif			// #if FACEBOOK_ENABLE || FACEBOOK_MODULE_ENABLE

#if FIREBASE_ENABLE || FIREBASE_MODULE_ENABLE
		["module.unitycommonfirebase"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommonfirebase_client.git#1.6.0",
#endif			// #if FIREBASE_ENABLE || FIREBASE_MODULE_ENABLE

#if GAME_ANALYTICS_ENABLE || GAME_ANALYTICS_ENABLE_MODULE_ENABLE
		["module.unitycommongameanalytics"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommongameanalytics_client.git#1.6.0",
#endif			// #if GAME_ANALYTICS_ENABLE || GAME_ANALYTICS_ENABLE_MODULE_ENABLE

#if SINGULAR_ENABLE || SINGULAR_MODULE_ENABLE
		["module.unitycommonsingular"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommonsingular_client.git#1.6.0",
#endif			// #if SINGULAR_ENABLE || SINGULAR_MODULE_ENABLE

#if GAME_CENTER_ENABLE || GAME_CENTER_MODULE_ENABLE
		["module.unitycommongamecenter"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommongamecenter_client.git#1.6.0",
#endif			// #if GAME_CENTER_ENABLE || GAME_CENTER_MODULE_ENABLE

#if PURCHASE_ENABLE || PURCHASE_MODULE_ENABLE
		["com.unity.purchasing"] = "3.2.3",
		["module.unitycommonpurchase"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommonpurchase_client.git#1.6.0",
#endif			// #if PURCHASE_ENABLE || PURCHASE_MODULE_ENABLE

#if NOTI_ENABLE || NOTI_MODULE_ENABLE
		["com.unity.mobile.notifications"] = "1.4.1",
		["module.unitycommon.Noti"] = "https://9tap:NT9studio!@gitlab.com/9tapmodule.repository/000001.module_unitycommon_Noti_client.git#1.6.0"
