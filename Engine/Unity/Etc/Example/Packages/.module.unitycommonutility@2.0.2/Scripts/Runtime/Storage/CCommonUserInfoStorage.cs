...
public class CCommonUserInfo : CCommonBaseInfo {
	...
	[IgnoreMember] public bool IsRemoveAds {
		get { return m_oIntDict.GetValueOrDefault(CCommonUserInfo.KEY_IS_REMOVE_ADS, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public EUserType UserType {
		get { return (EUserType)m_oIntDict.GetValueOrDefault(CCommonUserInfo.KEY_USER_TYPE, (int)EUserType.NONE); }
