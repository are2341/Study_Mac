...
public class CCommonAppInfo : CCommonBaseInfo {
	...
	[IgnoreMember] public bool IsAgree {
		get { return m_oIntDict.GetValueOrDefault(CCommonAppInfo.KEY_IS_AGREE, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public bool IsAgreeTracking {
		get { return m_oIntDict.GetValueOrDefault(CCommonAppInfo.KEY_IS_AGREE_TRACKING, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public bool IsFirstPlay {
		get { return m_oIntDict.GetValueOrDefault(CCommonAppInfo.KEY_IS_FIRST_PLAY, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
		set { m_oIntDict.ExReplaceVal(CCommonAppInfo.KEY_IS_FIRST_PLAY, value ? KCDefine.B_VAL_1_INT : KCDefine.B_VAL_0_INT); }
	}

	[IgnoreMember] public bool IsEnableShowTrackingDescPopup {
		get { return m_oIntDict.GetValueOrDefault(CCommonAppInfo.KEY_IS_ENABLE_SHOW_TRACKING_DP, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
		set { m_oIntDict.ExReplaceVal(CCommonAppInfo.KEY_IS_ENABLE_SHOW_TRACKING_DP, value ? KCDefine.B_VAL_1_INT : KCDefine.B_VAL_0_INT); }
	}

	[IgnoreMember] public int AppRunningTimes {
		get { return m_oIntDict.GetValueOrDefault(CCommonAppInfo.KEY_APP_RUNNING_TIMES, KCDefine.B_VAL_0_INT); }
	...
	[IgnoreMember] public System.DateTime InstallTime {
	...
	[IgnoreMember] public System.DateTime PrevPlayTime {
	...
	[IgnoreMember] private string InstallTimeStr => m_oStrDict.GetValueOrDefault(CCommonAppInfo.KEY_INSTALL_TIME, string.Empty);
	[IgnoreMember] private string PrevPlayTimeStr => m_oStrDict.GetValueOrDefault(CCommonAppInfo.KEY_PREV_PLAY_TIME, string.Empty);

	[IgnoreMember] private string CorrectInstallTimeStr => this.InstallTimeStr.Contains(KCDefine.B_TOKEN_SPLASH) ? this.InstallTimeStr : this.InstallTimeStr.ExToTime(KCDefine.B_DATE_T_FMT_YYYY_MM_DD_HH_MM_SS).ExToLongStr();
	[IgnoreMember] private string CorrectPrevPlayTimeStr => this.PrevPlayTimeStr.Contains(KCDefine.B_TOKEN_SPLASH) ? this.PrevPlayTimeStr : this.PrevPlayTimeStr.ExToTime(KCDefine.B_DATE_T_FMT_YYYY_MM_DD_HH_MM_SS).ExToLongStr();
...
#if UNITY_IOS
		var eiOSType = EiOSType.APPLE;
		this.Platform = CAccess.GetiOSName(eiOSType);
#elif UNITY_ANDROID
#if ANDROID_AMAZON_PLATFORM
		var eAndroidType = EAndroidType.AMAZON;
#elif ANDROID_ONE_STORE_PLATFORM
		var eAndroidType = EAndroidType.ONE_STORE;
#else
...
#else
		var eStandaloneType = EStandaloneType.MAC_APPLE;
