...
public class CProductInfoTable : CScriptableObj<CProductInfoTable> {
	...
	[SerializeField] private List<STProductInfo> m_oAndroidOneStoreProductInfoList = new List<STProductInfo>();
	#endregion			// 변수
	...
	public override void Awake() {
		...
		this.ProductInfoList.ExAddVals(m_oAndroidOneStoreProductInfoList);
#else
