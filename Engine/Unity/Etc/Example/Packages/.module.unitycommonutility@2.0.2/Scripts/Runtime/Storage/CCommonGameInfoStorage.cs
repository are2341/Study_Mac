...
public class CCommonGameInfo : CCommonBaseInfo {
	...
	[IgnoreMember] public bool IsMuteBGSnd {
		get { return m_oIntDict.GetValueOrDefault(CCommonGameInfo.KEY_IS_MUTE_BG_SND, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public bool IsMuteFXSnds {
		get { return m_oIntDict.GetValueOrDefault(CCommonGameInfo.KEY_IS_MUTE_FX_SNDS, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public bool IsDisableVibrate {
		get { return m_oIntDict.GetValueOrDefault(CCommonGameInfo.KEY_IS_DISABLE_VIBRATE, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public bool IsDisableNoti {
		get { return m_oIntDict.GetValueOrDefault(CCommonGameInfo.KEY_IS_DISABLE_NOTI, KCDefine.B_VAL_0_INT) != KCDefine.B_VAL_0_INT; }
	...
	[IgnoreMember] public float BGSndVolume {
		get { return m_oFltDict.GetValueOrDefault(CCommonGameInfo.KEY_BG_SND_VOLUME, KCDefine.B_VAL_0_FLT); }
		set { m_oFltDict.ExReplaceVal(CCommonGameInfo.KEY_BG_SND_VOLUME, value); }
	}

	[IgnoreMember] public float FXSndsVolume {
		get { return m_oFltDict.GetValueOrDefault(CCommonGameInfo.KEY_FX_SNDS_VOLUME, KCDefine.B_VAL_0_FLT); }
