...
//! 터치 사운드 재생자
public class CTouchSndPlayer : CUIComponent, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler {
	#region 변수
	...
	#region 함수
	//! 터치 시작 사운드 경로를 변경한다
	public void SetBeginSndPath(string a_oFilePath) {
		m_oBeginSndPath = a_oFilePath;
	}

	//! 터치 종료 사운드 경로를 변경한다
	public void SetEndSndPath(string a_oFilePath) {
		m_oEndSndPath = a_oFilePath;
	}
	#endregion			// 함수
}
