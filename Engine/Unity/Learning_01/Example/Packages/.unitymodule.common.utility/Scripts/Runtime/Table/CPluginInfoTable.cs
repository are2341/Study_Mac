...
public class CPluginInfoTable : CScriptableObj<CPluginInfoTable> {
	...
	[SerializeField] private string m_oTenjinAPIKey = string.Empty;
...
#if TENJIN_MODULE_ENABLE
	public string TenjinAPIKey => m_oTenjinAPIKey;
#endif			// #if TENJIN_MODULE_ENABLE
...
#if TENJIN_MODULE_ENABLE
	//! 텐진 API 키를 변경한다
	public void SetTenjinAPIKey(string a_oKey) {
		m_oTenjinAPIKey = a_oKey;
	}
#endif			// #if TENJIN_MODULE_ENABLE
