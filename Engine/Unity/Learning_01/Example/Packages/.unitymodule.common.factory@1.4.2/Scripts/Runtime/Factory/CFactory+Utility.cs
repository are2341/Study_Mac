...
public static partial class CFactory {
	#region 클래스 함수
	//! 시퀀스를 생성한다
	public static Sequence CreateSequence(Tween a_oAni, System.Action<Sequence> a_oCallback, float a_fDelay = KCDefine.B_VAL_0_FLT, Ease a_eEase = KCDefine.U_EASE_ANI, bool a_bIsJoin = false, bool a_bIsRealtime = false) {
	...
	//! 시퀀스를 생성한다
	public static Sequence CreateSequence(List<Tween> a_oAniList, System.Action<Sequence> a_oCallback, float a_fDelay = KCDefine.B_VAL_0_FLT, Ease a_eEase = KCDefine.U_EASE_ANI, bool a_bIsJoin = false, bool a_bIsRealtime = false) {
