...
public static partial class KEditorDefine {
	...
	public static Dictionary<System.Type, int> G_EXTRA_SCRIPT_ORDER_DICT = new Dictionary<System.Type, int>() {
		[typeof(Etc.E_E01Example_046)] = KCDefine.U_SCRIPT_O_SCENE_MANAGER,
		[typeof(Etc.E_E01Example_072)] = KCDefine.U_SCRIPT_O_SCENE_MANAGER
	};

	// 클래스 타입
	public static readonly Dictionary<string, System.Type> G_EXTRA_SCENE_MANAGER_TYPE_DICT = new Dictionary<string, System.Type>() {
		[KDefine.G_SCENE_N_E_E01_EXAMPLE_046] = typeof(Etc.E_E01Example_046),
		[KDefine.G_SCENE_N_E_E01_EXAMPLE_072] = typeof(Etc.E_E01Example_072)
	};
	#endregion			// 런타임 상수
}
