...
public static class CScriptableObjCreator {
	...
	public static void CreateOptsInfoTable() {
		...
		oOptsInfoTable.SetBuildOptsInfo(new STBuildOptsInfo() {
			m_bIsPreBakeCollisionMesh = false, m_bIsPreserveFrameBufferAlpha = false, m_eNormapMapEncoding = NormalMapEncoding.DXT5nm, m_eLightmapper = LightingSettings.Lightmapper.ProgressiveGPU,
	...
	public static void CreateBuildInfoTable() {
		...
		oBuildInfoTable.SetJenkinsInfo(new STJenkinsInfo() {
			m_oUserID = "dante", m_oBranch = "main", m_oSrc = "0000000000.Common/0300010101.Sample_Unity", m_oWorkspace = "/Users/dante/Documents/jenkins/workspace", m_oBuildToken = "JenkinsBuild", m_oAccessToken = "11769da7a267fd572b450b15e0e71b2f67", m_oBuildURLFmt = "http://127.0.0.1:8080/{0}/buildWithParameters"
		});
		...
		oBuildInfoTable.SetStandaloneBuildInfo(new STStandaloneBuildInfo() {
			m_oCategory = "public.app-category.games", m_oTargetOSVer = "10.13.0"
		});
	}
	...
	public static void CreatePluginInfoTable() {
		...
		Facebook AppID: 4124229680930360
		Facebook Client Token: 17c26327b196d9cd9917995c8ebd594e
		*/
	...
	public static void CreateProductInfoTable() {
		...
		oProductInfoTable.SetCommonProductInfos(new List<STProductInfo>() {
			new STProductInfo {
				m_oID = "dante.distribution.sample.iap.nc.pkgs.beginner", m_eProductType = ProductType.NonConsumable,
			...
			new STProductInfo {
				m_oID = "dante.distribution.sample.iap.nc.pkgs.expert", m_eProductType = ProductType.NonConsumable,
			...
			new STProductInfo {
				m_oID = "dante.distribution.sample.iap.nc.pkgs.pro", m_eProductType = ProductType.NonConsumable,
			...
			new STProductInfo {
				m_oID = "dante.distribution.sample.iap.c.single.coinsbox", m_eProductType = ProductType.Consumable,
			...
			new STProductInfo {
				m_oID = "dante.distribution.sample.iap.nc.single.removeads", m_eProductType = ProductType.NonConsumable,
