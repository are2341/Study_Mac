	...
	private static void SetupRenderingPipeline(EQualityLevel a_eQualityLevel, UniversalRenderPipelineAsset a_oRenderingPipeline, bool a_bIsEnableAssert = true) {
		...
		if(a_oRenderingPipeline != null) {
			...
			var oIsSetupOptsList = new List<bool>() {
				...
				((float)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_BORDER)).ExIsEquals(KCDefine.B_VAL_2_REAL / KCDefine.B_UNIT_DIGITS_PER_TEN),
				((float)a_oRenderingPipeline.ExGetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_2_SPLIT)).ExIsEquals(KCDefine.B_VAL_1_REAL / KCDefine.B_VAL_4_REAL),
			...
			if(oIsSetupOptsList.Contains(false)) {
				...
				a_oRenderingPipeline.ExSetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_BORDER, KCDefine.B_VAL_2_REAL / KCDefine.B_UNIT_DIGITS_PER_TEN);
				a_oRenderingPipeline.ExSetRuntimeFieldVal<UniversalRenderPipelineAsset>(KCEditorDefine.U_FIELD_N_UNIVERSAL_RP_CASCADE_2_SPLIT, KCDefine.B_VAL_1_REAL / KCDefine.B_VAL_4_REAL);
