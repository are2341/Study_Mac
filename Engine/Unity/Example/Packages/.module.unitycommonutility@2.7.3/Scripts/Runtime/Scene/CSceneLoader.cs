...
public partial class CSceneLoader : CSingleton<CSceneLoader> {
	...
	#region 프로퍼티
	public string PrevActiveSceneName { get { return m_oStrDict.GetValueOrDefault(EKey.PREV_ACTIVE_SCENE_NAME, string.Empty); } set { m_oStrDict.ExReplaceVal(EKey.PREV_ACTIVE_SCENE_NAME, value); } }
	public string AwakeActiveSceneName { get { return m_oStrDict.GetValueOrDefault(EKey.AWAKE_ACTIVE_SCENE_NANE, string.Empty); } set { m_oStrDict.ExReplaceVal(EKey.AWAKE_ACTIVE_SCENE_NANE, value); } }
	#endregion			// 프로퍼티
