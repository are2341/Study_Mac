...
public static partial class CExtension {
	...
	/** 리스트를 복사한다 */
	public static void ExCopyTo<T>(this List<T> a_oSender, List<T> a_oDestValList, System.Func<T, T> a_oCallback, bool a_bIsClear = true, bool a_bIsEnableAssert = true) {
	...
	/** 딕셔너리를 복사한다 */
	public static void ExCopyTo<K, V>(this Dictionary<K, V> a_oSender, Dictionary<K, V> a_oDestValDict, System.Func<V, V> a_oCallback, bool a_bIsClear = true, bool a_bIsEnableAssert = true) {
	...
	/** 리스트 => 딕셔너리로 변환한다 */
	public static List<V> ExToList<K, V>(this Dictionary<K, V> a_oSender) {
		CAccess.Assert(a_oSender != null);
		var oList = new List<V>();

		foreach(var stKeyVal in a_oSender) {
			oList.Add(stKeyVal.Value);
		}
